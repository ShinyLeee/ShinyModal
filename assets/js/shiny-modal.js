  ...
  ShinyModal.prototype.renderType = function (type) {
    ...
    switch (type) {
      case 'alert':
        ...
        var closeButton = new Element('Close', 'btn primary', function () { that.hide() })
      ...
      case 'confirm':
        ...
        var cancelButton = new Element('Cancel', 'btn secondary', function () { that.hide() })
        $buttonHolder.prepend(cancelButton)

        var confirmButton = new Element('Confirm', 'btn primary', $.proxy(function (e) { this.options.callback(e) }, this))
